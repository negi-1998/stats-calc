...
#pragma resource "*.fmx"
TmystdDevForm *mystdDevForm;
//---------------------------------------------------------------------------
__fastcall TmystdDevForm::TmystdDevForm(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
std::vector<float> ungroupedData;
void __fastcall TmystdDevForm::ungroupedOkButtonClick(TObject *Sender)
{
...
void __fastcall TmystdDevForm::ungroupedCalcButtonClick(TObject *Sender)
{
	...
	result = sqrt(stdDevNumerator/ungroupedData.size());
...
void __fastcall TmystdDevForm::groupedOkButtonClick(TObject *Sender)
{
...
void __fastcall TmystdDevForm::groupedCalcButtonClick(TObject *Sender)
{
	...
	float result = sqrt(stdDevNumerator/total_freq);
