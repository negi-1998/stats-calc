...
#ifndef varianceFormH
#define varianceFormH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TmyvarianceForm : public TForm
{
...
public:		// User declarations
	__fastcall TmyvarianceForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TmyvarianceForm *myvarianceForm;
//---------------------------------------------------------------------------
#endif
